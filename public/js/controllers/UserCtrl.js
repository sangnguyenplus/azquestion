...
.controller('UserController', ['$scope', '$state', '$rootScope', '$cookieStore', '$window', '$http', '$location', '$stateParams', 'flash', '$modal', 'appAlert', 'User', 'AuthenticationService', 'socket',
    function($scope, $state, $rootScope, $cookieStore, $window, $http, $location, $stateParams, flash, $modal, appAlert, User, AuthenticationService, socket) {
    ...
    $scope.deleteUser = function(id, path) {
        appAlert.confirm({title: 'Xóa', message: 'Bạn chắc chắn muốn xóa thành viên này ?'}, function(isOk) {
            if (isOk) {
                User.delete(id)
...
.controller('ProfileUserController', ['appAlert', 'flash', 'Restangular', '$modal', '$scope', '$rootScope', '$http', '$state', '$stateParams', 'User', 'Badge',
    function(appAlert, flash, Restangular, $modal, $scope, $rootScope, $http, $state, $stateParams, User, Badge) {
